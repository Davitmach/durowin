...
// <div className="bg-[#8643FA] flex-1 h-[200px] flex flex-col gap-[16px]  ">
// <div className="flex items-center justify-center"><img src={'/bak.png'}/></div>
//     <div className="flex items-center justify-center"><img src={'/bak.png'}/></div>
//     <div className="flex items-center justify-center"><img src={'/bak.png'}/></div>
//     <div className="flex items-center justify-center"><img src={'/bak.png'}/></div>
//     <div className="flex items-center justify-center"><svg width="48" height="44" viewBox="0 0 48 44" fill="none" xmlns="http://www.w3.org/2000/svg">
// <path d="M47.096 9.2534L26.1734 42.5707C25.9174 42.9742 25.5634 43.3063 25.1443 43.5358C24.7252 43.7653 24.2548 43.8849 23.777 43.8833C23.2991 43.8817 22.8295 43.759 22.412 43.5267C21.9944 43.2943 21.6426 42.9599 21.3894 42.5547L0.874708 9.2374C0.298918 8.30476 -0.00408665 7.22946 4.16276e-05 6.1334C0.0246105 4.51422 0.691303 2.9711 1.85349 1.84342C3.01568 0.715733 4.57819 0.0958398 6.19737 0.120069H41.8294C45.2347 0.117403 48 2.80007 48 6.1174C48 7.21874 47.6907 8.30674 47.096 9.2534ZM5.91471 8.1334L21.176 31.6694V5.7654H7.50937C5.93071 5.7654 5.22404 6.81074 5.91471 8.13874M26.8214 31.6747L42.088 8.1334C42.7947 6.80807 42.072 5.76007 40.4907 5.76007H26.8267L26.8214 31.6747Z" fill="white"/>
// </svg>
// </div>
//     <div className="flex items-center justify-center"><img src={'/bak.png'}/></div>
// </div>
...
// </div>
//             </div>
//             <div><button className="spin_btn bg-[#742CF1] rounded-[100px] w-[113px] h-[113px] font-[700] text-white text-[32px] cursor-pointer border-[7px] border-[#8643FA]">SPIN</button></div>
//         </div>
  ...
  const handleSpin = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        ...
        withResult[0].push(...data.result.row_1);
        withResult[1].push(...data.result.row_2);
        withResult[2].push(...data.result.row_3);
